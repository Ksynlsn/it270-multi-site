...
// unregister the original blanslate sidebar
function remove_my_widgets(){
   // Unregister some of the blank slate sidebars
   unregister_sidebar( 'primary-widget-area' );
   } // 11 = prioity of 11 ensures fucntions in child theme run after fucntions in paeent theme
   add_action( 'widgets_init', 'remove_my_widgets', 11 ); 

// now, register my own sidebar
